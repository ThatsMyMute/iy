...
Credits.Text = "Edge // Zwolf // Moon // Toon // Modded by ThatsMyMute"
...
CMDs = {}
--CMds[#CMDs + 1] = {NAME = 'idk tell me', DESC = 'bypassed dex for games with anti-dex made for macsploit'}
--CMDs[#CMDs + 1] = {NAME = 'jailbreak_script', DESC = 'Loads project auto'}
CMDs[#CMDs + 1] = {NAME = 'executor', DESC = 'Loads an in game executor'}
...
CMDs[#CMDs + 1] = {NAME = 'Free / Gamepass / Freegp', DESC = 'Free gamepasses'}
CMDs[#CMDs + 1] = {NAME = 'mm2script', DESC = 'MM2 script'}
wait()
...
addcmd('Free', {'Gamepass', 'Free'}, function(args, speaker)
...
addcmd('executor', {}, function(args, speaker)
  loadstring(game:HttpGet("https://raw.githubusercontent.com/v9h/krnl/main/ui.lua"))()
end)

addcmd('MM2', {'mm2script'}, function(args, speaker)
